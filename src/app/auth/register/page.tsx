...
export default function RegisterPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (signInRes?.error) {
                throw new Error(signInRes.error === "CredentialsSignin" ? "Registration successful, but sign in failed." : signInRes.error);
            }
        ...
        try {
            ...
            if (res?.error) {
                toast({
                    ...
                    description: res.error === "CredentialsSignin" ? "Failed to link Google account." : res.error,
                    variant: "destructive",
                });
            } else {
                toast({
        ...
        <div className="flex min-h-[calc(100vh-4rem)] items-center justify-center bg-neutral-50 px-4 py-12">
            <Card className="w-full max-w-md shadow-xl border-neutral-200">
                <CardHeader className="space-y-1 text-center pb-8 border-b">
                    <CardTitle className="text-3xl font-bold tracking-tight text-neutral-900">Create an Account</CardTitle>
                    <CardDescription className="text-neutral-600">
                        Join your campus community to start sharing resources.
                    </CardDescription>
                </CardHeader>
                <CardContent className="pt-8 space-y-4">
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="college" className="text-neutral-900 font-medium">College / University Name</Label>
                            <Input
                                id="college"
                                className="text-neutral-900 placeholder:text-neutral-400"
